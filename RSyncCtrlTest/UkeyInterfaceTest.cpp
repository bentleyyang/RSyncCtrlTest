#include "stdafx.h"
#include "UkeyInterfaceTest.h"

#include "util.h"

//CPPUNIT_TEST_SUITE_REGISTRATION(UkeyInterfaceTest);
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(UkeyInterfaceTest, "登录测试");


UkeyInterfaceTest::UkeyInterfaceTest()
{
}
...
void UkeyInterfaceTest::setUp()
{

}

void UkeyInterfaceTest::tearDown()
{

}

void UkeyInterfaceTest::testGetUserList()
{
...
void UkeyInterfaceTest::testGetCertBase64String()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testCertLogin()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testCertLoginNoPwd()
{
	return;
	using namespace rapidjson;
...
void UkeyInterfaceTest::testGetPinRetryCount()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testKeySignByP7()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testKeySignByP1()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testVerifySignByP1()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testChangePassWd()
{
	//return;
...
void UkeyInterfaceTest::testVerifyIdentity()
{
	using namespace rapidjson;
	//预期成功1 加密证书
	{
...
void UkeyInterfaceTest::testKeyGetKeySn()
{
	using namespace rapidjson;
	//预期成功
	{
...
void UkeyInterfaceTest::testKeyGetDeviceInfo()
{
	using namespace rapidjson;
	//预期成功1 设备序列号
	{
...
void UkeyInterfaceTest::testKeyDigitalSignByP1()
{

}

void UkeyInterfaceTest::testVerifyDigitalSignByP1()
{

}

void UkeyInterfaceTest::testKeyEncryptData()
{
	using namespace rapidjson;
	//预期成功1
	{
...
void UkeyInterfaceTest::testKeyDecryptData()
{
	using namespace rapidjson;
	//预期成功1
	{
...

		{
			...
			CPPUNIT_ASSERT(rsKeyContent=="1234");
		}
	}
...
void UkeyInterfaceTest::testKeyEncryptFile()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testKeyDecryptFile()
{
	using namespace rapidjson;
...
void UkeyInterfaceTest::testKeyEncryptByDigitalEnvelope()
{

}

void UkeyInterfaceTest::testKeyDecryptByDigitalEnvelope()
{
...
*/
void UkeyInterfaceTest::testKeyStatus()
{
	//预期成功1
	{
		CPPUNIT_ASSERT(login());
